...
INSERT INTO "new_projects" ("color", "createdAt", "description", "id", "name", "order", "status", "subgroupId", "templateId", "updatedAt") SELECT "color", "createdAt", "description", "id", "name", "order", "status", "subgroupId", "templateId", "updatedAt" FROM "projects";
DROP TABLE "projects";
